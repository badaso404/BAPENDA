...
if (isset($_POST["submit"])) {
    if (tambah($_POST)>0){
        ...
        document.location.href = 'lihattransaksi.php';
    </script>
    ";
}
else{
                            ...
                            <table class="table table-dark table-striped border border-1 border-secondary">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-select" id="jenis_pajak" name="jenis_pajak">
                                        ...
                                        <option value="1">Pajak Restoran</option>
                                        <option value="2">Pajak Reklame</option>
                                        <option value="3">Pajak Hotel</option>
                                    </select>
                                </div>
                                <br>

                                <center><a href="transaksihotel.php" class="btn btn-success">Next</a></center>
                                <br>
                        </div>
                    </div>
        </div>
